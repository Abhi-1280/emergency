...
class Vehicle(pygame.sprite.Sprite):
    def __init__(self, lane, vehicleClass, direction_number, direction, will_turn):
        ...
        self.stop = defaultStop[direction]  # Initialize stop position
            ...
            for lane in vehicles[direction]:
                if isinstance(lane, int):
                    for vehicle in vehicles[direction][lane]:
                        if vehicle != self:
                            if (abs(x - vehicle.x) < gap2 and abs(y - vehicle.y) < gap2):
                                return True
        return False
        ...
        if self.direction == 'right':
            ...
            if self.willTurn:
                if self.crossed == 0 or self.x + self.currentImage.get_rect().width < mid[self.direction]['x']:
                    if (self.x + self.currentImage.get_rect().width <= self.stop or (currentGreen == 0 and currentYellow == 0) or self.crossed == 1 or self.isEmergency):
                    ...
                    if self.turned == 0:
                        ...
                        if not self.check_collision(self.x + 2, self.y + 1.8):
                            self.x += 2
                            self.y += 1.8
                ...
                if (self.x + self.currentImage.get_rect().width <= self.stop or self.crossed == 1 or (currentGreen == 0 and currentYellow == 0) or self.isEmergency):
                    if not self.check_collision(self.x + self.speed, self.y):
                        self.x += self.speed
            ...
            if self.willTurn:
                if self.crossed == 0 or self.y + self.currentImage.get_rect().height < mid[self.direction]['y']:
                    if (self.y + self.currentImage.get_rect().height <= self.stop or (currentGreen == 1 and currentYellow == 0) or self.crossed == 1 or self.isEmergency):
                        if not self.check_collision(self.x, self.y + self.speed):
                            self.y += self.speed
                else:
                    if self.turned == 0:
                        self.rotateAngle += rotationAngle
                        self.currentImage = pygame.transform.rotate(self.originalImage, -self.rotateAngle)
                        if not self.check_collision(self.x - 2.5, self.y + 2):
                            self.x -= 2.5
                            self.y += 2
                        if self.rotateAngle == 90:
                            self.turned = 1
                ...
                if (self.y + self.currentImage.get_rect().height <= self.stop or self.crossed == 1 or (currentGreen == 1 and currentYellow == 0) or self.isEmergency):
                    if not self.check_collision(self.x, self.y + self.speed):
                        self.y += self.speed
            ...
            if self.willTurn:
                if self.crossed == 0 or self.x > mid[self.direction]['x']:
                    if (self.x >= self.stop or (currentGreen == 2 and currentYellow == 0) or self.crossed == 1 or self.isEmergency):
                        if not self.check_collision(self.x - self.speed, self.y):
                            self.x -= self.speed
                else:
                    if self.turned == 0:
                ...
                if (self.x >= self.stop or self.crossed == 1 or (currentGreen == 2 and currentYellow == 0) or self.isEmergency):
                    if not self.check_collision(self.x - self.speed, self.y):
                        self.x -= self.speed
            ...
            if self.willTurn:
                if self.crossed == 0 or self.y > mid[self.direction]['y']:
                    if (self.y >= self.stop or (currentGreen == 3 and currentYellow == 0) or self.crossed == 1 or self.isEmergency):
                        if not self.check_collision(self.x, self.y - self.speed):
                            self.y -= self.speed
                else:
                    if self.turned == 0:
                ...
                if (self.y >= self.stop or self.crossed == 1 or (currentGreen == 3 and currentYellow == 0) or self.isEmergency):
                    if not self.check_collision(self.x, self.y - self.speed):
                        self.y -= self.speed                    
